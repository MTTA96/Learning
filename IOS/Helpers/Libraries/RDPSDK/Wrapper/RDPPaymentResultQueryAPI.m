...
//    [self checkVarCompletion];
    NSString* urlString = RDP_RAPI_PAYMENT_QUERY_DEV_URL;
    if([RDPUtil isProduction])
        urlString = RDP_RAPI_PAYMENT_QUERY_PRODUCTION_URL;
...
- (void) onSuccessWith:(RDPWsResponse*)responseObject {
    ...
    RDPPaymentResultQueryResponse *response = (RDPPaymentResultQueryResponse*) responseObject;
