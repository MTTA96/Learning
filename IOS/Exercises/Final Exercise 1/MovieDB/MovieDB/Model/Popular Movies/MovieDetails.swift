...
struct MovieDetails : Codable {
	...
	init(from decoder: Decoder) throws {
		...
		belongs_to_collection = try values.decodeIfPresent(Collection.self, forKey: .belongs_to_collection)
...
extension MovieDetails {
    ...
    //Get movie details
    static func getMovieDetails(movieId: Int, result: @escaping (_ error: String?, _ details: MovieDetails?) -> Void) {
        let url = ServerUrl.movieUrl + "/\(movieId)"
        let params: Parameters = ["api_key" : ServerUrl.apiKey]
